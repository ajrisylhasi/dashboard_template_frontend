      ...
      <Box sx={{ borderRadius: "15px" }}>
        <Box height="12vh" maxHeight="12vh" display="flex" justifyContent="center" alignItems="center" margin="15px">
          ...
          <Box width="10%" height="100%" display="flex" justifyContent="center">
            <Box height="100%" onClick={() => navigate("/feed")} display="flex" sx={{ borderRadius: '50%', boxShadow: "-5px 5px 8px 1px rgba(0,0,0,0.3)", aspectRatio: "1/1", backgroundColor: "#fff", justifyContent: "center", alignItems: "center" }}>
